...
import com.RachasitbGmailCom.RachasitbGmailComSProxFzl.estimote.NearestBeaconManager;
        ...
        proximityContentManager.setListener(new ProximityContentManager.Listener() {
            ...
            public void onContentChanged(Object content) {
                ...
                if (content != null) {
                    ...
                    myBeaconDetail = beaconDetails.getBeaconName().toString();
                    backgroundColor = BACKGROUND_COLORS.get(beaconDetails.getBeaconColor());
                    Log.e("BEEEEEEEE",backgroundColor.toString());
    ...
    protected void onStart() {
        ...
        beaconManager.connect(new BeaconManager.ServiceReadyCallback() {
            ...
            public void onServiceReady() {
                ...
                Spinner spin = (Spinner) findViewById(R.id.mySpinnerRage);
        ...
        new CountDownTimer(10500, 500) {
            ...
            public void writeToFile(String data) {
                try {
                    ...
                    File root = new File("/sdcard", "kmuttFiles"); //##For Unroot Devices Path
                    //File root = new File(getCacheDir(), "kmuttFile"); //## For Rooted Devices
                    //File root = new File(getCacheDir(), "beeFile");
